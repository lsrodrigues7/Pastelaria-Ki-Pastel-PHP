<?php 
	...
	$pdf->SetTextColor(0,0,0);
	 ...
	 $sql = mysqli_query($conexao,"SELECT funcionarios.func_cod, funcionarios.func_nome, funcionarios.func_cpf, funcionarios.func_celular, funcionarios.func_data_nascimento as nascimento, funcionarios.func_cargo, usuarios.usu_cod, usuarios.usu_nome as usuNome FROM funcionarios INNER JOIN usuarios ON funcionarios.usu_cod=usuarios.usu_cod;");

...
<html>
    <head>
        <meta charset="utf-8">
        <title>Relatório de Fornecedores por período</title>
    ...
    <body  background="#"  >
        <br><br><br>
            <div class="container">
                <div class="box">
                  <h3><span class="badge badge-light">Relatório de Fornecedores por período</span></h3>
            <form id="frmRelProd" name="frmRelProd" method="POST" action="../relatorios/relFornPeriodo.php">

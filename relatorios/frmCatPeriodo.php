...
<html>
    <head>
        <meta charset="utf-8">
        <title>Relatório de Categorias por período</title>
    ...
    <body  background="#"  >
        <br><br><br>
            <div class="container">
                <div class="box">
                  <h3><span class="badge badge-light">Relatório de Categorias por período</span></h3>
            <form id="frmRelCat" name="frmRelCat" method="POST" action="relCatPeriodo.php">

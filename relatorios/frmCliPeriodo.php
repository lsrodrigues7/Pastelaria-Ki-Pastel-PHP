...
<html>
    <head>
        <meta charset="utf-8">
        <title>Relatório de Clientes por período</title>
    ...
    <body  background="#"  >
        <br><br><br>
            <div class="container">
                <div class="box">
                  <h3><span class="badge badge-light">Relatório de Clientes por período</span></h3>
            <form id="frmRelCli" name="frmRelCli" method="POST" action="../relatorios/relCliPeriodo.php">

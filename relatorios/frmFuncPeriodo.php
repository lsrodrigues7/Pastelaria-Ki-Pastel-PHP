...
<html>
    <head>
        <meta charset="utf-8">
        <title>Relatório de Funcionários por período</title>
    ...
    <body  background="#"  >
        <br><br><br>
            <div class="container">
                <div class="box">
                  <h3><span class="badge badge-light">Relatório de Funcionários por período</span></h3>
            <form id="frmRelFunc" name="frmRelFunc" method="POST" action="relFuncPeriodo.php">
